...
metadata {
    definition (name: "TKB TZ35-S Single wall dimmer", namespace: "Zinsoft", author: "Grzegorz Zalewski") {
        capability "Switch"
    ...
    preferences {
        ...
        input name : "nightLight", type: "enum", options: ["0" : "LED is ON when the load attached is OFF", "1" : "LED is ON when the load attached is ON"], title: "Night light", description: "The LED behaviour based on the load attached. (default value is LED is ON when the load attached is ON)"
